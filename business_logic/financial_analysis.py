...
def calculate_enhanced_financials(
    ...
    federal_itc_amount = system_cost_gross * FEDERAL_ITC_RATE if include_federal_itc else 0
    ...
    roi_25_years = (net_profit_25_years / system_cost_net) * 100 if system_cost_net > 0 else 0
    ...
    return {
        ...
        "total_energy_generated_25_years": sum(y["generation_kwh"] for y in yearly_breakdown),
