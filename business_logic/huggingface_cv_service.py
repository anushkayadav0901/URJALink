...
class HuggingFaceRoofSegmentation:
    ...
    def __init__(self):
        ...
        self.building_class_ids = [
            ...
            50,
            68,
        ]  # wall, building, house, skyscraper, roof, rooftop
...
def extract_roof_data_from_hf_response(
    ...
    if polygon_pixels:
        ...
        for pixel_x, pixel_y in polygon_pixels:
            lat, lng = pixel_to_latlng(pixel_x, pixel_y, center_lat, center_lng, zoom)
            polygon_coords.append([lat, lng])

    # Estimate orientation based on polygon shape
    orientation_degrees, orientation_cardinal = _estimate_roof_orientation(
        polygon_pixels
    )
