 ...
 *An AI-driven sustainability platform that transforms rooftops into renewable power insights: revealing untapped solar potential, energy savings, and carbon reduction opportunities in seconds.*
...
URJALINK was built to close this gap. Our goal: make sustainability *data-driven, transparent, and easy to act on.*
...
```json
{
  ...
  "state": "CA",
  "zip_code": "94102",
  "user_polygon": [[37.775, -122.419], [37.775, -122.4185], [37.7745, -122.4185]]
}
```
